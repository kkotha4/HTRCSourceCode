...
def get_volumes(token, volume_ids, host, port, cert, key, epr, concat=True):
    """
...
def download_volumes(volume_ids, output_dir, username=None, password=None,
                     config_path=None, token=None, concat=True, host=None, port=None, cert=None, key=None, epr=None):
